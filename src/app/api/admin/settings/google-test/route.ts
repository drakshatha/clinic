/**
 * GET /api/admin/settings/google-test
 * Tests the Google Places API connection and returns live review data.
 * Used by the admin Settings tab "Test Connection" button.
 */
...
export async function GET() {
  ...
  try {
    ...
    const res = await fetch(url, { cache: "no-store" }); // bypass cache for test
